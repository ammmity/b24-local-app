...
define('C_REST_CLIENT_ID','local.67be3a52035fb7.92353084');//Application ID
define('C_REST_CLIENT_SECRET','s2fcO298xgeB6H8ebLbvM7RSfne96izeSTKokzSHuTqbUvQZfz');//Application key
