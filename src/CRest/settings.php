<?
define('C_REST_CLIENT_ID','local.67b0f1a9e9a452.42195881');//Application ID
define('C_REST_CLIENT_SECRET','CVAzReG21nFkiQ0cdpde7duV7uMnQjJjfL8zqat6rxcm4rlNI5');//Application key
// or
